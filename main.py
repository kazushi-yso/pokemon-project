class pokemon:
    def __init__(self,name,type,hp,at):
        self.name=name
        self.type=type
        self.hp=hp
        self.at=at
...
hikozaru=pokemon("ヒコザル","ほのお",450,50)
naetoru=pokemon("ナエトル","くさ",450,50)

pocchama=pokemon("ポッチャマ","みず",450,50)
